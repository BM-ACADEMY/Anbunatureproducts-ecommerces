...
const SummaryApi = {
  ...
  // IMPORTANT: The 'addReview' endpoint was missing. I've added it here.
  addReview: {
    url: "/api/product/add-review", // This URL should match your backend endpoint for adding reviews
    method: "POST", // Reviews are typically created via POST request
  },
