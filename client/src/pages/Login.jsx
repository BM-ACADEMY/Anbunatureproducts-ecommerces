        ...
        <section className="flex items-center justify-center min-h-[calc(100vh-4rem)] bg-gray-50 p-4">
            <form onSubmit={handleSubmit} className="max-w-96 w-full text-center border border-gray-300/60 rounded-2xl px-8 py-10 bg-white shadow-sm">
                ...
                <div className="mt-4 text-right">
                    <Link className="text-xs text-indigo-500 hover:text-indigo-600 font-medium" to="/forgot-password">
                        Forgot password?
                    </Link>
                </div>
                ...
                <button 
                    ...
                    className="mt-6 w-full h-11 rounded-full text-white bg-indigo-500 hover:opacity-90 transition-opacity disabled:bg-gray-400 disabled:cursor-not-allowed font-medium text-sm flex items-center justify-center"
                >
                    {isLoading ? (
                ...
                <p className="text-gray-500 text-sm mt-6">
                    ...
                    <Link className="text-indigo-500 hover:text-indigo-600 font-medium" to="/register">
                        Sign up
                    </Link>
                </p>
            </form>
