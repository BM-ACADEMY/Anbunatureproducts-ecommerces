...
const Processing = () => {
  const { totalPrice, totalQty, fetchCartItem, fetchOrder, settings } =
    useGlobalContext();
  ...
  const displayTotalQty = singleItem ? singleItem.quantity : totalQty;

  const [donationAmount, setDonationAmount] = useState(
    location.state?.donationAmount || 0,
  );
  const [foundationSettings, setFoundationSettings] = useState(null);

  const displayTotalOfferPrice = singleItem
    ? singleItem.selectedAttributes.reduce(
  ...
  const shippingCharge =
    displayTotalOfferPrice >= (settings?.freeShippingThreshold || 0) &&
    settings?.freeShippingThreshold > 0
      ? 0
      : settings?.shippingCharge || 0;

  const displayTotalPrice =
    displayTotalOfferPrice + donationAmount + shippingCharge;
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        subTotal: displayTotalOfferPrice,
        shippingCharge: shippingCharge,
        totalPrice: displayTotalPrice, // This matches server expectation for grand total usually
      };
        ...
        return (
          <div className="bg-white shadow-2xl rounded-3xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 md:p-8 bg-[#f3f9f2] border-r border-green-50">
                ...
                <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar mb-6">
                  {displayCartItems.map((item, index) => {
                    ...
                    return (
                      <div
                        key={item._id || index}
                        className="flex gap-3 items-start p-2.5 rounded-xl bg-white border border-gray-100 shadow-sm"
                      >
                        ...
                        <div className="flex-grow min-w-0">
                          <h4 className="font-bold text-gray-800 text-xs line-clamp-2">
                            {item.productId?.name}
                          </h4>
                          <p className="text-[10px] text-gray-400 italic mb-1 truncate">
                ...
                <div className="space-y-3 text-sm text-gray-700 pt-4 border-t border-gray-200">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`${shippingCharge === 0 ? "text-green-600 font-bold" : "text-gray-900 font-semibold"}`}
                    >
                      {shippingCharge === 0
                        ? "FREE"
                        : DisplayPriceInRupees(shippingCharge)}
                    </span>
                  </div>
                  ...
                  <div className="pt-3 flex justify-between items-center text-2xl font-black text-slate-900 border-t border-dashed border-gray-300 mt-2">
                    <span className="tracking-tight">Grand Total</span>
                    <span className="text-[#196806]">
              ...
              <div className="p-8 md:p-10 flex flex-col items-center justify-center text-center bg-white">
                <div className="max-w-xs mx-auto">
                  ...
                  <p className="text-gray-500 text-sm mb-8">
                    Scan the QR code below using any UPI app like GPay, PhonePe,
                    or Paytm.
                  </p>
                  ...
                  <div className="relative group p-4 bg-white rounded-3xl border-2 border-dashed border-blue-100 shadow-sm transition-all hover:border-blue-300">
                    ...
                    <div className="mt-4 p-3 bg-blue-50 rounded-2xl flex items-center justify-between gap-3">
                      <div className="flex flex-col items-start px-1 overflow-hidden">
                        <span className="text-[10px] text-[#196806] font-bold uppercase tracking-wider">
                          UPI ID
                        </span>
                  ...
                  <div className="mt-8 space-y-4 w-full">
                    <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                      ...
                      <p className="text-3xl font-black text-[#196806]">
                        {DisplayPriceInRupees(displayTotalPrice)}
                      </p>
                    </div>
                    <button
        ...
        return (
          <div className="bg-white shadow-2xl rounded-3xl p-8 md:p-10 animate-in slide-in-from-right duration-300">
            ...
            <p className="text-gray-500 mb-8 max-w-lg">
              To verify your transaction, please upload a screenshot of your
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
              <div className="relative group">
                ...
                >
                  <div className="w-16 h-16 bg-red-500 text-white rounded-full flex items-center justify-center mb-4 transition-transform group-hover:scale-110 shadow-lg shadow-red-100">
                    <svg
                      className="w-8 h-8"
                      fill="none"
                      stroke="currentColor"
                  ...
                  <span className="text-gray-400 text-sm font-medium">
                    PNG, JPG up to <span className="font-bold text-gray-600">5MB</span>
                  </span>
                </label>
              </div>
              ...
              <div className="h-full">
                {uploadedImage ? (
                  <div className="relative h-full flex flex-col items-center">
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 self-start">
                      Preview
                    </p>
                  ...
                  <div className="h-64 flex flex-col items-center justify-center bg-gray-50 rounded-3xl border-2 border-gray-100 p-6 text-center">
                    ...
                    <p className="text-gray-400 text-sm font-medium">
                      Upload a screenshot to see preview here
                    </p>
                  </div>
                )}
              </div>
      ...
      case 3:
        return (
          <div className="bg-white shadow-2xl rounded-3xl p-8 md:p-10 animate-in slide-in-from-right duration-300">
            ...
            <div className="mb-8 bg-gray-50/50 rounded-3xl p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                {displayCartItems.map((item, index) => {
                  const itemPrice = item.selectedAttributes.reduce((s, a) => s + (a.offerPrice || a.price || 0), 0);
                  return (
                    <div key={index} className="flex gap-4 items-center p-3 bg-white rounded-2xl border border-gray-50 shadow-sm transition-all hover:shadow-md">
                      ...
                      <div className="flex-grow min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span className="text-[10px] px-2 py-0.5 bg-gray-100 text-gray-600 rounded-full font-bold">Qty: {item.quantity}</span>
                        </div>
                      </div>
                      <div className="text-right flex-shrink-0">
                        <p className="font-black text-green-700 text-base">{DisplayPriceInRupees(itemPrice * item.quantity)}</p>
                        <p className="text-[10px] text-gray-400 font-bold">{DisplayPriceInRupees(itemPrice)} / unit</p>
                      </div>
                    </div>
                  );
                })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-[#f3f9f2] p-8 rounded-2xl border border-green-50 shadow-sm flex flex-col">
                ...
                <div className="space-y-3 flex-grow">
                  ...
                  <div className="flex justify-between text-[15px] text-gray-600 font-medium">
                    <span>Shipping</span>
                    <span className={`font-bold ${shippingCharge === 0 ? "text-green-600" : "text-gray-900"}`}>
                      {shippingCharge === 0 ? "FREE" : DisplayPriceInRupees(shippingCharge)}
                    </span>
                  </div>
                  {donationAmount > 0 && (
                    <div className="flex justify-between text-[15px] text-blue-600 font-bold">
                      <span>Donation</span>
                      <span>+ {DisplayPriceInRupees(donationAmount)}</span>
                    </div>
                  )}
                  <div className="pt-4 mt-4 border-t border-dashed border-gray-300 flex justify-between items-center text-2xl font-black text-gray-900">
                    <span className="tracking-tight">Grand Total</span>
                    <span className="text-[#196806]">
                      {DisplayPriceInRupees(displayTotalPrice)}
                    </span>
              ...
              >
                {isLoading ? (
                  <span className="flex items-center gap-3">
                    ...
                    <span className="tracking-wide">Processing Order...</span>
                  </span>
                ) : (
                  "Place Order Now"
                )}
            ...
            <p className="text-[10px] text-slate-400 text-center mt-4 leading-relaxed">
              By placing this order, you agree to Anbu Natural's <NavLink to="/terms-and-conditions" className="underline hover:text-green-600">Terms & Conditions</NavLink>, <NavLink to="/shipping-policy" className="underline hover:text-green-600">Shipping Policy</NavLink> and <NavLink to="/return-refund-policy" className="underline hover:text-green-600">Return & Refund Policy</NavLink>.
            </p>
          </div>
        );
      case 4:
        return (
          <div className="bg-white shadow-2xl rounded-3xl p-10 text-center animate-in zoom-in duration-500">
            ...
            <p className="text-gray-600 mb-8 max-w-md mx-auto leading-relaxed">
              ...
              payment details and will process your request shortly.
            </p>
