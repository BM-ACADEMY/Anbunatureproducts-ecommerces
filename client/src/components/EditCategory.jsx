        ...
        <form onSubmit={handleSubmit} className='p-8 space-y-7'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex flex-wrap items-start gap-5'>
              ...
              {/* Upload Box */}
              <label htmlFor='uploadImgEdit' className='flex-grow h-32 border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center gap-2 cursor-pointer hover:border-indigo-400 hover:bg-indigo-50/30 transition-all active:scale-[0.98] group'>
                {loading ? (
