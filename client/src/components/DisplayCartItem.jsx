          ...
          <>
            ...
            <div className="p-4 bg-white border-t border-gray-100">
              <button
                ...
                className="w-full bg-[#fbb034] hover:bg-[#f39c12] text-black font-bold text-lg py-4 rounded-xl shadow-md transition-all active:scale-[0.98] flex items-center justify-center"
              >
                Checkout
              </button>
            </div>
